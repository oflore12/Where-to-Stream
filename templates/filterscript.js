...
for (const x of genres) {
  genreslist += `<option value="${x}">${x}</option>`;
}
genreslist += `</select>`;
...
const payOptions = ["Flatate", "Free", "Ads", "Rent", "Buy"]
...
for (const x of payOptions) {
  payList += `<option value="${x}">${x}</option>`;
}
payList += `</select>`;
...
function getGenre() {
  genreFilter = document.getElementById('genreSelected');
  if (genreFilter.value != "" || genreFilter.value != "All_G") {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=" + genreFilter.value);
  }
  genreFilter = "";
}

function getPayingOption() {
  payingFilter = document.getElementById('paySelected');
  if (payingFilter.value != "" || payingFilter.value != "All_PO") {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=" + payingFilter.value);
  }
}

function getCountry() {
  countryFilter = document.getElementById('countrySelected');
...
function getYear() {
  ...
  year.innerHTML = yearFilter.value;
  yearFilter.oninput = function() {
    year.innerHTML = this.value;
  }

  if (yearFilter.value.value != "") {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&year=" + yearFilter.value);
  }
}

function getRating() {
  ratingFilter = document.getElementById("rateFilter");
  var rate = ratingFilter.value
  console.log(rate);
  if (rate == 0) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=0&vote_average.lte=0.9&with_original_language=en");
  }

  else if (rate == 1) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=1&vote_average.lte=1.9&with_original_language=en");
  }
   else if (rate == 2) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=2&vote_average.lte=2.9&with_original_language=en");
  }
 else if (rate == 3) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=3&vote_average.lte=3.9&with_original_language=en");
  }
else  if (rate == 4) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=4&vote_average.lte=4.9&with_original_language=en");
  }
 else if (rate == 5) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=5&vote_average.lte=5.9&with_original_language=en");
  }
  else if (rate == 6) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=6&vote_average.lte=6.9&with_original_language=en");
  }
 else if (rate == 7) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=7&vote_average.lte=7.9&with_original_language=en");
  }
else  if (rate == 8) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=8&vote_average.lte=8.9&with_original_language=en");
  }
else  if (rate == 9) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=9&vote_average.lte=9.9&with_original_language=en");
  }
 else if (rate == 10) {
    getMovies("https://api.themoviedb.org/3/discover/movie?api_key=523e00cfc7fcc6bed883c38162ea974d&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&vote_average.gte=10&with_original_language=en");
  }
}
...
function cardItem(y, a, b, id) {
  ...
  x += '<p class="card-text">' + a + '</p></div></div>'
  return x;
}
